...
o.bind("SUPER + O", "Pop window out (float & pin)", hl.dsp.window.float({ action = "toggle", pin = true }))
...
o.bind("SUPER + code:61", "Cycle monitor scaling", "hyprctl keyword monitor ,preferred,auto,1 && hyprctl reload")

...
CFG=$(nix eval --impure --raw --expr "
  let
    ...
    theme = themes.\"$THEME\";
    helpers = (import ./modules/home-manager/lib.nix { inherit lib; });
    mod = import ./modules/home-manager/integration/hyprland.nix { inherit theme helpers; };
...
CFG=$(nix eval --impure --raw --expr "
  let
    ...
    theme = themes.\"$THEME\";
    helpers = (import ./modules/home-manager/lib.nix { inherit lib; });
    mod = import ./modules/home-manager/integration/alacritty.nix { inherit theme helpers; };
...
CFG=$(nix eval --impure --raw --expr "
  let
    ...
    theme = themes.\"$THEME\";
    helpers = (import ./modules/home-manager/lib.nix { inherit lib; });
    mod = import ./modules/home-manager/integration/hyprlock.nix { inherit theme helpers; };
...
CFG=$(nix eval --impure --raw --expr "
  let
    ...
    theme = themes.\"$THEME\";
    helpers = (import ./modules/home-manager/lib.nix { inherit lib; });
    mod = import ./modules/home-manager/integration/waybar.nix { inherit theme helpers; };
